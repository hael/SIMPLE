...
public class SimpleEoVolAssembleCalculation extends ApplicationWrapper 
{

  private static Logger log = Logger.getLogger(SimpleEoVolAssembleCalculation.class.getName());
  ...
  /** Constructor */
  public SimpleEoVolAssembleCalculation(String[] args) 
  {
  ...
  protected void execute() throws Throwable 
  {
    ...
    invokesimpleEoVolAssemble();
  }

  private void invokesimpleEoVolAssemble() throws IOException 
  {

    ProcessWrapper process = new ProcessWrapper(new File(workingDirectory));

    String run_application = "ls -sF";
    process.execute(run_application);
    log.info("Execute simpleEoVolAssemble: " + run_application);
