...
contains
    ...
    subroutine rot_imgbatch( imgs, os, imgsum, msk )
        ...
        cmat = zero
        !$omp parallel do default(shared) private(i,h,k,l,m,loc,mat,logi,phys,cyc1,cyc2,w,comps,win,incr)&
