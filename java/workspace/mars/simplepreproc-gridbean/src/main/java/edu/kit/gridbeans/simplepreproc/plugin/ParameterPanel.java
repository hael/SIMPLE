...
public class ParameterPanel extends GridBeanPanel {
	...
	private void linkComponents() throws DataSetException {
		linkTextField(SimplePreProcGridBean.TITLE, tfdTitle);
		setValueTranslator(SimplePreProcGridBean.TITLE, new StringValueTranslator());
		setValueValidator(SimplePreProcGridBean.TITLE, new NonEmptyStringValidator());
