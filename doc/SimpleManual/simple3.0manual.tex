...
\begin{itemize}
    \item[--] A new DDD movie pre-processing program \prgname{unblur\_movies} that implements motion correction, dose-weighting \citep{grant2015measuring} and automatic correlation-based frame weighting . 
