...
program testing_fft_3D_D2Z_cpu
  ...
  call t_fft_cpu%new_fft_3D_DZ_cpu(nx,ny,nz)

  write(*,*)'                                                               '
  write(*,*)'************** CPU 3D FFTW D2Z -> Z2D *************************'
  write(*,*)'                                                               '
  ...
  fhpq = 0.0d0
  call start_timer_cpu("D2Z_cpu")
  call t_fft_cpu%gather_fft_3D_D2Z_cpu(nx,ny,nz,fxyz,fhpq)
  call stop_timer_cpu("D2Z_cpu")

  fxyz_cpu = 0.0d0
  call start_timer_cpu("Z2D_cpu")
  call t_fft_cpu%gather_fft_3D_Z2D_cpu(nx,ny,nz,fhpq,fxyz_cpu)
  call stop_timer_cpu("Z2D_cpu")
