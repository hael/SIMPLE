...
contains
    ...
    module subroutine bind_input_carg(self, reg)
        ...
        call reg%add_char('nu_hist_potts', self%nu_hist_potts)
        ...
        call reg%add_char('so3_graph', self%so3_graph)
        call reg%add_char('so3_steering', self%so3_steering)
    ...
    module subroutine bind_input_iarg(self, reg)
        ...
        call reg%add_int('so3_local_cluster2d_maxits', self%so3_local_cluster2d_maxits)
