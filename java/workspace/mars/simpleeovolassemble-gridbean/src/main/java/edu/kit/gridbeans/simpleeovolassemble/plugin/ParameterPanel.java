...
public class ParameterPanel extends GridBeanPanel {
	...
	private void linkComponents() throws DataSetException {
		linkTextField(SimpleEoVolAssembleGridBean.TITLE, tfdTitle);
		setValueTranslator(SimpleEoVolAssembleGridBean.TITLE, new StringValueTranslator());
		setValueValidator(SimpleEoVolAssembleGridBean.TITLE, new NonEmptyStringValidator());
