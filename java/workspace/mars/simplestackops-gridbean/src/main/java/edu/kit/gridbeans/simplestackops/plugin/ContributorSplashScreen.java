...
public class ContributorSplashScreen extends JDialog {
	...
	setTitle("Contributors to the GridBean (java) "+VersionStackops.getVersionStackopsGridBean());
	setModal(true);
	...
	String msg =
	    ...
	    "<br>" +
	    "The current GridBean (version :"+VersionStackops.getVersionStackopsGridBean()+") is for Pre-processing Cryo-EM images using the SIMPLE library (version: "+VersionStackops.getVersionStackops()+").</p>"
