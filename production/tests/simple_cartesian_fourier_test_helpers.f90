! Test-only fixtures discovered through the existing Cartesian-suite filename glob.
module cartesian_fourier_test_helpers
...
end module cartesian_fourier_test_helpers
