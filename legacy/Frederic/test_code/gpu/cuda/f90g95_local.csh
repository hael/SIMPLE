...
OPTION="-ffree-form -cpp -fPIC -fno-second-underscore -O3 -fopenmp $PLAT -DOPENMP -DBENCH -DCUDA -DMAGMA"
...
$GFORTRAN $OPTION -I $OBJDIR -I $MODDIR -o $FLNAME \
                                           ...
                                           $OBJDIR/Global_wavelets.o \
                                           $OBJDIR/waveletsD_c.o \
                                           $OBJDIR/waveletsD.o \
                                           $OBJDIR/wavelets_Coefficient.o \
                                           $OBJDIR/wavelets_FilterCoefs.o \
                                           $OBJDIR/wavelets_TransForm1D.o \
                                           $OBJDIR/wavelets_TransForm2D.o \
                                           $OBJDIR/wavelets_TransFormCm.o \
				           $OBJDIR/wavelets_Convoluters.o \
                                           -L $FFTW_LIB -lfftw3 \
                                           -L $FFTW_LIB -lfftw3f \
