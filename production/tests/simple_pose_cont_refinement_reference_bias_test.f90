module pose_cont_refinement_reference_bias_test
...
use pose_cont_refinement_matched_window_test, only: matched_reference_metrics, &
...
end module pose_cont_refinement_reference_bias_test
