...
type :: builder
    ...
    type(euclid_sigma2)                 :: esig                   !< raw/reconstruction euclidean sigma2 noise variance
    type(euclid_sigma2)                 :: esig_match             !< optional matching sigma2 for denoised particle matching
