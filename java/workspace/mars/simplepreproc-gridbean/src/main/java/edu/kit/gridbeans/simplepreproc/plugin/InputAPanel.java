...
public class InputAPanel extends GridBeanPanel 
{
  ...
  private void linkComponents() throws DataSetException 
  {
    ...
    add(editor1);
    linkTextEditor(SimplePreProcGridBean.INPUT_FILE, editor1);
    setValueTranslator(SimplePreProcGridBean.INPUT_FILE, new GPELocalFileValueTranslator());
    setValueValidator(SimplePreProcGridBean.INPUT_FILE, FileIsReadableAndNotDirectoryValidator.getInstance());
  }
