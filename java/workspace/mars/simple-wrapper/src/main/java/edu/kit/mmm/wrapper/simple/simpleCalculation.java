...
public class simpleCalculation extends ApplicationWrapper {

  private static Logger log = Logger.getLogger(simpleCalculation.class.getName());
  ...
  /** Constructor */
  public simpleCalculation(String[] args) 
  {
  ...
  private void invokesimple() throws IOException {
    ...
    log.info("Execute simple: " + run_application);
    ...
    Commands to run application on MASSIVE
    String run_application = "/home/unicore/Inputs_and_executables/dlpoly/DLPOLY.Z";
