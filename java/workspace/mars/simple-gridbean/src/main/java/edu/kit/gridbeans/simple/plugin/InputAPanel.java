...
public InputAPanel(Client client, INode node) 
  ...
  private void linkComponents() throws DataSetException 
  {
    ...
    add(editor1);
    linkTextEditor(SimpleGridBean.INPUT_FILE, editor1);
    setValueTranslator(SimpleGridBean.INPUT_FILE, new GPELocalFileValueTranslator());
    setValueValidator(SimpleGridBean.INPUT_FILE, FileIsReadableAndNotDirectoryValidator.getInstance());
  }
