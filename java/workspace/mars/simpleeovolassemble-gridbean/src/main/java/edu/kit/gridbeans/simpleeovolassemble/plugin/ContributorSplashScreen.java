...
public class ContributorSplashScreen extends JDialog {
	...
	setTitle("Contributors to the GridBean (java) "+VersionEoVolAssemble.getVersionEoVolAssembleGridBean());
	setModal(true);
	...
	String msg =
	    ...
	    "<br>" +
	    "The current GridBean (version :"+VersionEoVolAssemble.getVersionEoVolAssembleGridBean()+") is for Pre-processing Cryo-EM images using the SIMPLE library (version: "+VersionEoVolAssemble.getVersionEoVolAssemble()+").</p>"
