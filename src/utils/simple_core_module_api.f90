...
use simple_estimate_ssnr, only: fsc2optlp, fsc2optlp_sub, gaussian_filter, fsc2boostfilter, get_resolution,&
...
! estimate_ssnr
public :: fsc2optlp, fsc2optlp_sub, gaussian_filter, fsc2boostfilter, get_resolution,&
         &get_resolution_at_fsc, lpstages, lpstages_fast, edit_lpstages4polar
! fileio
