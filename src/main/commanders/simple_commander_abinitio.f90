...
subroutine exec_initial_3Dmodel( self, cline )
    ...
    if( do_autoscale )then
        call autoscale(params%box, params%smpd, smpd_target, params%box_crop, params%smpd_crop, scale_factor1)
    ...
    call cline_refine3D_snhc%set('box',        real(params%box))
    call cline_refine3D_snhc%set('box_crop',   real(params%box_crop))
    call cline_refine3D_snhc%set('smpd',       params%smpd)
