...
contains
    ...
    module subroutine bind_input_carg(self, reg)
        ...
        call reg%add_char('fine_model', self%fine_model)
        ...
        call reg%add_char('prob_assign', self%prob_assign)
        ...
        call reg%add_char('relational_features', self%relational_features)
    ...
    module subroutine bind_input_iarg(self, reg)
        ...
        call reg%add_int('relational_knn', self%relational_knn)
    ...
    module subroutine bind_input_rarg(self, reg)
        ...
        call reg%add_real('relational_corr_hp', self%relational_corr_hp)
        call reg%add_real('relational_corr_lp', self%relational_corr_lp)
        call reg%add_real('relational_corr_trs', self%relational_corr_trs)
        call reg%add_real('relational_weight_tau', self%relational_weight_tau)
