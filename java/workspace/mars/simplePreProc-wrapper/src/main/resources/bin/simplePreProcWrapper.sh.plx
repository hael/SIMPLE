...
C1=/plx/userexternal/sbozic00/m3hpc/mmm_wrapper/lib/simplePreProcApplicationWrapper-0.1-SNAPSHOT.jar
...
java -Xmx1024m -cp $CLASSPATH edu.kit.mmm.wrapper.simplePreProc.simplePreProcLauncher \
