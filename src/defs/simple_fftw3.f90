!@descr: FFTW3 interface. See www.fftw.org and /usr/include/fftw3.f03
module simple_fftw3
  ...
  interface
    ...
    integer(C_INT) function fftw_strlen(s) bind(C, name='strlen')
        import
        type(C_PTR), value :: s
    end function fftw_strlen

    subroutine fftw_free_str(p) bind(C, name='free')
        import
        type(C_PTR), value :: p
    end subroutine fftw_free_str
  end interface
