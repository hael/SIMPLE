...
real, parameter    :: SH_SAFE              = .1        !< safe shift error, used in shift_sampling (in Angstroms)
...
integer, parameter :: NPEAKS_ORIW          = 50        !< number of peaks to use for calculating particle weights
