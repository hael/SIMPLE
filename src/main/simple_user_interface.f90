...
type(simple_program), target :: autorefine3D_nano_eo
...
contains
    ...
    subroutine set_prg_ptr_array
        ...
        call push2prg_ptr_array(autorefine3D_nano_eo)
    ...
    subroutine list_single_prgs_in_ui
        ...
        write(logfhandle,'(A)') autorefine3D_nano_eo%name
