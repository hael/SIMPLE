...
public class InputAPanel extends GridBeanPanel 
{
  ...
  private void linkComponents() throws DataSetException 
  {
    ...
    add(editor1);
    linkTextEditor(SimpleStackopsGridBean.INPUT_FILE, editor1);
    setValueTranslator(SimpleStackopsGridBean.INPUT_FILE, new GPELocalFileValueTranslator());
    setValueValidator(SimpleStackopsGridBean.INPUT_FILE, FileIsReadableAndNotDirectoryValidator.getInstance());
  }
