...
class Project{
  ...
  constructor(){
    this.projectselector = pug.compileFile(global.simplepath + '/gui_data/client/src/projectselector.pug')
    this.projecthistory = pug.compileFile(global.simplepath + '/gui_data/client/src/projecthistory.pug')
    this.createproject = pug.compileFile(global.simplepath + '/gui_data/client/src/createproject.pug')
