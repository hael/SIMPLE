...
contains
    ...
    subroutine exec_cavg_filter2D( self, cline )
        ...
        integer  :: nptcls, iptcl, nptcls_pftcc
        logical  :: l_ctf
        ...
        nptcls_pftcc = size(pinds)
        call pftcc%new(nptcls_pftcc, [1,nptcls_pftcc], params%kfromto)
        call pftcc%reallocate_ptcls(nptcls_pftcc, pinds)
