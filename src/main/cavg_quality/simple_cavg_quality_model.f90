...
contains
    ...
    function pool_model_spec() result( spec )
        ...
        spec%intercept               = 3.019428E+00
        spec%linear_coefficients     = [ &
            1.268326E+00,  3.091599E+00, -7.943187E-02,  4.681069E-01, &
            1.538036E-01, -4.866532E-01,  8.805990E-01,  7.159065E-01, &
           -1.467243E+00, -4.635519E-01, -1.547664E-01, -9.735187E-01, &
            8.455722E-02,  5.908242E-01 ]
        call set_pairwise_interactions_for_feature_count(spec, 14, [ &
            8.124296E-01, -1.829462E-01, -2.587485E-01,  1.677675E-01, &
            1.422908E-02, -7.020678E-02,  7.143927E-01, -1.243306E-01, &
            2.544687E-01, -1.702746E-01,  9.135658E-02,  4.959708E-01, &
           -5.818582E-01,  1.566720E-01, -2.855620E-02, -2.015557E-01, &
            1.045865E+00, -2.365080E-01, -1.121613E+00,  3.090424E-01, &
            2.274267E-02,  1.648266E-01, -4.589186E-01, -8.001740E-02, &
           -3.104777E-01, -9.325293E-02,  1.397948E-01, -3.621736E-01, &
           -1.976701E-01,  2.338754E-02,  5.125606E-01,  8.931822E-02, &
           -1.713008E-01,  3.526318E-01, -1.127295E-01, -2.138436E-01, &
           -3.042429E-01,  5.765420E-01,  3.108448E-01, -4.964497E-01, &
            6.538461E-01, -2.241187E-01,  2.513196E-01, -2.798098E-01, &
            3.086750E-01, -6.282231E-01,  2.715049E-02,  3.062534E-01, &
            5.802850E-01,  1.344755E-01,  2.921259E-01, -4.666455E-02, &
            4.980305E-03,  1.299387E-01, -3.740664E-01, -5.862606E-01, &
            1.021881E+00,  1.343090E+00, -5.806900E-01, -4.460776E-03, &
            4.459684E-01, -1.337408E+00, -4.283012E-01, -9.037281E-02, &
           -2.563778E-01, -3.231134E-01, -4.257302E-01, -3.994936E-01, &
           -4.260610E-01,  5.954123E-01,  1.103425E-01,  5.087613E-01, &
           -3.248595E-01,  3.537865E-01, -6.991459E-01, -4.826571E-02, &
           -6.536254E-01, -1.580407E-02, -2.842349E-01,  1.340060E+00, &
            2.286135E-01, -2.391035E-01,  2.647482E-01, -3.137802E-01, &
            6.259218E-01, -8.486449E-02, -2.166955E-01,  4.763646E-01, &
           -2.689782E-01,  1.173058E-01, -1.728300E+00 ])
        spec%prob_threshold          = 3.500000E-01
