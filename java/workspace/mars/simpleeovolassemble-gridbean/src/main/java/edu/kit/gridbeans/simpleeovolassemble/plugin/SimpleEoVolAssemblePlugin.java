...
public class SimpleEoVolAssemblePlugin extends GridBeanPlugin 
{
  ...
  public void initialize(Client client, INode node) 
  {
    ...
    try {
    addInputPanel(new SimpleEoVolAssemblePanel(client, node));
  ...
  public Icon getIcon() 
  {
    return getOrCreateIcon(SimpleEoVolAssembleGridBean.class, "images/icon.png");
  }
