...
! PRIME2D
character(len=11),     parameter :: CLUSTER2D_ITER_FBODY      = 'cluster2Ddoc_'
character(len=10),     parameter :: CAVGS_ITER_FBODY          = 'cavgs_iter'
! PRIME2D STREAM
character(len=10),     parameter :: SCSTK_DIR                 = 'stacks_sc/'
! PRIME3D
character(len=11),     parameter :: REFINE3D_ITER_FBODY       = 'refine3Ddoc_'
...
character(len=9),      parameter :: PREPROCESS_STREAM_DIR     = 'pipeline/'
character(len=21),     parameter :: MOTION_CORRECT_STREAM_DIR = PREPROCESS_STREAM_DIR//'micrographs/'
character(len=13),     parameter :: CTF_STREAM_DIR            = PREPROCESS_STREAM_DIR//'ctf/'
character(len=15),     parameter :: PICK_STREAM_DIR           = PREPROCESS_STREAM_DIR//'boxes/'
character(len=19),     parameter :: EXTRACT_STREAM_DIR        = PREPROCESS_STREAM_DIR//'particles/'
character(len=17),     parameter :: UNIDOC_STREAM_DIR         = PREPROCESS_STREAM_DIR//'unidocs/'
! oritype enumeration
enum, bind(c)
