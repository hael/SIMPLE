...
public class ParameterPanel extends GridBeanPanel {
	...
	private void linkComponents() throws DataSetException {
		linkTextField(SimplePrimeGridBean.TITLE, tfdTitle);
		setValueTranslator(SimplePrimeGridBean.TITLE, new StringValueTranslator());
		setValueValidator(SimplePrimeGridBean.TITLE, new NonEmptyStringValidator());
