...
\end{SCfigure}
These images represent a subset of particles from a larger TRPV1 data set (EMPAIR-10005). In order to cluster the images, execute:
\begin{verbatim}
...
\end{figure}
%\begin{wrapfigure}{l}{01.0\textwidth}
%\includegraphics[keepaspectratio=true,scale=0.8]{./Pfrib3D/Pfrib3D}
%\caption{Progress of the 3D model throughout the stochastic PRIME3D search (top). Class averages vs. re-projections of the converged 3D reconstruction (bottom).}
%\end{wrapfigure}
