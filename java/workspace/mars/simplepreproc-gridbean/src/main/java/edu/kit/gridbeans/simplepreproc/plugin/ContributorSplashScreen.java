...
public class ContributorSplashScreen extends JDialog {
	...
	String msg =
	    ...
	    "<br>" +
	    "The current GridBean (version :"+Version.getVersionSimpleGridBean()+") is for Pre-processing Cryo-EM images using the SIMPLE library (version: "+Version.getVersionSimple()+").</p>"
