...
subroutine set_ui_params
    ...
    call nu_hist_potts%set_param(  'nu_hist_potts',   'binary', 'NU histogram-constrained Potts', &
                                   'Constrain 3D nonuniform-filter Potts cleanup to preserve the raw unary label histogram(yes|no){no}', &
                                   '(yes|no){no}', .false., 'no')
