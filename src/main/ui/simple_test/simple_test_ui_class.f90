...
type(category_descriptor), parameter :: UI_CATEGORY = category_descriptor('class', 'Class', 10)
...
subroutine new_strategy2D( tsttab )
        ...
        ! add to ui_hash
        call add_ui_program('strategy2D', strategy2D, tsttab, UI_CATEGORY)
