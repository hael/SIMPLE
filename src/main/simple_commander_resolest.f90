...
public :: opt_3D_filter_test_commander
...
type, extends(commander_base) :: opt_3D_filter_test_commander
  contains
    procedure :: execute      => exec_opt_3D_filter_test
end type opt_3D_filter_test_commander
