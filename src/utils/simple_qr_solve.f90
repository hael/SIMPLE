...
function ddot ( n, dx, incx, dy, incy ) result(ddot_var)
...
function dnrm2 ( n, x, incx ) result (dnrm2_var)
...
!    system.
!
!    Output, real ( kind = 8 ) R(M), the residual, B - A*X.  R may
!    overwrite B.
!
