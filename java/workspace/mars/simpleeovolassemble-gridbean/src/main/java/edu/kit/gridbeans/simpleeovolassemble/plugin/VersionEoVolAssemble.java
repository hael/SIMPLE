 ...
 *
 */
public class VersionEoVolAssemble {

	/**
	 * version for the Eo_RecVol GridBean
	 * @return v1.0:String
	 */
	public static String getVersionEoVolAssembleGridBean() {
		return "v1.0";
	}
	/**
	 * version for the Eo_Vol_Assemble application
	 * @return November 24th of November 2015 - version 1.0:String
	 */
	public static String getVersionEoVolAssemble() {
