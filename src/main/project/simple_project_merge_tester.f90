...
contains
    ...
    subroutine test_merge_2d_selection_heterogeneous_ctf()
        ...
        call assert_int(2 * NCLS, reread%os_cls2D%get_noris(), 'merged cls2D count')
        call assert_int(2 * NCLS, reread%os_cls3D%get_noris(), 'merged cls3D count')
        call assert_int(2, reread%os_out%get_noris(), 'merged out count')
        ...
        call assert_int(1, reread%os_ptcl2D%get_class(1), 'project 1 particle class')
        call assert_int(NCLS + 1, reread%os_ptcl2D%get_class(NPTCLS1 + 1), 'project 2 particle class remapped')
        call assert_int(NCLS + 2, reread%os_ptcl2D%get_class(NPTCLS1 + 2), 'project 2 second class remapped')
        ...
        call assert_int(1, reread%os_cls2D%get_class(1), 'project 1 cls2D class')
        call assert_int(NCLS + 1, reread%os_cls2D%get_class(NCLS + 1), 'project 2 cls2D class remapped')
        call assert_int(1, reread%os_cls2D%get_state(1), 'project 1 cls2D state preserved')
        call assert_int(0, reread%os_cls2D%get_state(NCLS + 1), 'project 2 cls2D state preserved')
        ...
        call assert_int(2, reread%os_cls2D%get_int(NCLS + 1, 'ogid'), 'project 2 class ogid remapped')
