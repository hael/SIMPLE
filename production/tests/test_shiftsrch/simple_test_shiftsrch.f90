...
call img_copy%polarize(pftcc, 1, isptcl=.true.)
call img_copy%bwd_ft
...
call img_copy%polarize(pftcc, 2, isptcl=.true.)
call img_copy%bwd_ft
...
call img_copy%polarize(pftcc, 3, isptcl=.true.)
call img_copy%bwd_ft
...
call img_copy%polarize(pftcc, 4, isptcl=.true.)
call img_copy%bwd_ft
...
call img_copy%polarize(pftcc, 5, isptcl=.true.)
call img_copy%bwd_ft
...
call img_copy%polarize(pftcc, 6, isptcl=.true.)
call img_copy%bwd_ft
...
call img_copy%polarize(pftcc, 7, isptcl=.true.)
call img_copy%bwd_ft
...
call img_copy%polarize(pftcc, 8, isptcl=.true.)
call img_copy%bwd_ft
