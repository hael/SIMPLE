! ============================================================================
! Name        : testing_fft_2D_C2C_cpu.f90
...
! ============================================================================
!
program testing_fft_2D_C2C_cpu
...
!  call t_fft_cpu%new_fft_2D_CC_cpu(nx,ny)
  ...
  fhp = 0.0
  call t_fft_cpu%gather_fft_2D_C2C_cpu(nx,ny,fuv,fhp,FFTW_FORWARD)

  fuv_cpu = 0.0
  call t_fft_cpu%gather_fft_2D_C2C_cpu(nx,ny,fhp,fuv_cpu,FFTW_BACKWARD)
...
end program testing_fft_2D_C2C_cpu
