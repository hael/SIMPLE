...
use single_ui_atom,       only: construct_single_atom_programs
use single_ui_map,        only: construct_single_map_programs
use single_ui_nano2D,     only: construct_single_nano2D_programs
use single_ui_nano3D,     only: construct_single_nano3D_programs
use single_ui_trajectory, only: construct_single_trajectory_programs
use single_ui_tseries,    only: construct_single_tseries_programs
use single_ui_validate,   only: construct_single_validate_programs
implicit none

public :: add_single_programs
private
