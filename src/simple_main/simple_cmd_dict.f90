...
contains
    ...
    subroutine init_cmd_dict
        ...
        call chdict%push('countvox',      'count the number of voxels(yes|no){no}')
        call chdict%push('cs',            'spherical aberration constant(in mm){2.7}')
        call chdict%push('ctf',           'ctf flag(yes|no|flip){no}')
        ...
        call chdict%push('lpstart',       'start low-pass limit{15}')
        call chdict%push('lpstop',        'stop low-pass limit{8}')
        call chdict%push('masscen',       'center using binarisation and mass centering(yes|no){no}')
        call chdict%push('maxits',        'maximum number of iterations{500}')
        ...
        call chdict%push('newbox',        'new box size(in pixels)')
        ...
        call chdict%push('outside',       'only extract boxes within the micrograph boundaries(yes|no){yes}')
        call chdict%push('outstk',        'output image stack{outstk.ext}')
        call chdict%push('outvol',        'output volume{outvol.ext}')
        call chdict%push('pgrp',          'point-group symmetry(cn|dn|t|o|i){c1}')
        call chdict%push('phrand',        'phase randomize(yes|no){no}')
        call chdict%push('plot',          'make plot(yes|no){no}')
        call chdict%push('pspecsz',       'size of power spectrum(in pixels){512}')
        ...
        call chdict%push('shrink',        'shrink factor')
        ...
        call chdict%push('use_gpu',       'execute SIMPLE on GPU(yes|no){no}')
        ...
        call chdict%push('nnn',           'number of nearest neighbors{500}')
        ...
        call chdict%push('offset',        'pxels offset{3}')
