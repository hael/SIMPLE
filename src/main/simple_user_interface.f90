...
contains
    ...
    subroutine new_cluster2D
        ...
        call cluster2D%set_input('filt_ctrls', 8, 'lambda', 'num', 'TV regularization lambda parameter', 'Strength of noise reduction', '(0.5-3.0){2.0}', .false., 2.0)
        ! mask controls
    ...
    subroutine new_filter
        ...
        call filter%set_input('filt_ctrls',12, 'lambda', 'num', 'Tv filter lambda', 'Strength of noise reduction', '(0.5-3.0){2.0}', .false., 2.0)
    ...
    subroutine new_refine3D
        ...
        call refine3D%set_input('srch_ctrls', 10, 'refine', 'multi', 'Refinement mode', 'Refinement mode(shc|neigh|cluster|clustersym){shc}', '(snhc|shc|neigh|cluster|clustersym){shc}', .false., 'shc')
