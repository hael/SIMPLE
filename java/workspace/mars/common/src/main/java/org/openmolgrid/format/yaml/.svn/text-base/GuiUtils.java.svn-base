...
//		return new ImageIcon(GuiUtils.class.getClassLoader().getResource(filename));
	...
	/**
	 * another method to create a custom size button private static final Dimension BUTTON_SIZE = new Dimension(100,25); 
	 * @param text
	 * @param listener
	 * @return button
	 */
	...
	/**
	 * Method to generate a button of a custom size private static final Dimension BUTTON_SIZE_2 = new Dimension(120,25);
	 * @param text
	 * @param listener
	 * @return button
	 */
	...
	/**
	 * Method to generate a button of a size private static final Dimension BUTTON_SIZE_3 = new Dimension(200,25);
	 * @param text
	 * @param listener
	 * @return button
	 */
