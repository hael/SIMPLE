...
! ============================================================================
!
program testing_cuFFT_3D_S2C_gpu
...
!  call t_cuFFT_gpu%new_cuFFT_3D_SC_gpu(nx,ny,nz)

  write(*,*)'                                                               '
  write(*,*)'************** GPU 3D cuFFT S2C -> C2S ************************'
  write(*,*)'                                                               '
  ...
  call t_cuFFT_gpu%gather_fft_3D_S2C_gpu(nx,ny,nz,fxyz,fhpq)
  call stop_timer_cpu("S2C_gpu")

  fxyz_gpu = 0.0
  call start_timer_cpu("C2S_gpu")
  call t_cuFFT_gpu%gather_fft_3D_C2S_gpu(nx,ny,nz,fhpq,fxyz_gpu)
...
end program testing_cuFFT_3D_S2C_gpu
