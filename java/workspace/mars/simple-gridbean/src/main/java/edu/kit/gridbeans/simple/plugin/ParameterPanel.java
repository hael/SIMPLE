...
public class ParameterPanel extends GridBeanPanel {
	...
	private void linkComponents() throws DataSetException {
		linkTextField(SimpleGridBean.TITLE, tfdTitle);
		setValueTranslator(SimpleGridBean.TITLE, new StringValueTranslator());
		setValueValidator(SimpleGridBean.TITLE, new NonEmptyStringValidator());
