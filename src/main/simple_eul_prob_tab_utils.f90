...
contains
    ...
    subroutine materialize_seed_shift( assgn, seed_shift, seed_has_sh, l_doshift, pftc )
    ...
    subroutine write_seed_shift_table( funit, addr, seed_shifts, seed_has_sh )
    ...
    subroutine read_seed_shift_table( funit, addr, seed_shifts, seed_has_sh )
        integer, intent(in)    :: funit
        integer, intent(inout) :: addr
