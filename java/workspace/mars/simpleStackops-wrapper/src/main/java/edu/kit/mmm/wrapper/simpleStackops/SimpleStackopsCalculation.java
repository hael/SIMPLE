...
public class SimpleStackopsCalculation extends ApplicationWrapper 
{

  private static Logger log = Logger.getLogger(SimpleStackopsCalculation.class.getName());
  ...
  /** Constructor */
  public SimpleStackopsCalculation(String[] args) 
  {
  ...
  protected void execute() throws Throwable 
  {
    ...
    invokesimpleStackops();
  }

  private void invokesimpleStackops() throws IOException 
  {
    ...
    log.info("Execute simpleStackops: " + run_application);
