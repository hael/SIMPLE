...
public class InputAPanel extends GridBeanPanel 
{
  ...
  private void linkComponents() throws DataSetException 
  {
    ...
    add(editor1);
    linkTextEditor(SimplePrimeGridBean.INPUT_FILE, editor1);
    setValueTranslator(SimplePrimeGridBean.INPUT_FILE, new GPELocalFileValueTranslator());
    setValueValidator(SimplePrimeGridBean.INPUT_FILE, FileIsReadableAndNotDirectoryValidator.getInstance());
  }
