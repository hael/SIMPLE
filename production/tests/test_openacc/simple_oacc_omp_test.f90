...
! #include "openacc_lib.h"
    ...
    public:: test_oacc_omp, test_oacc_omp_matrixmul, test_gang_static_addition, test_oacc_reduction
...
#else
! acc kernels imbedded in omp not supported
#endif
            ...
            print *,"test_oacc_omp: OPENACC not supported. _OPENACC ", openacc_version
        endif
...
#if defined(_OPENACC) && ! defined(GNU)
        if(openacc_version >= 201306)then
    ...
    subroutine test_gang_static_addition
        ...
        integer i, a(n), b(n)
        print *,"OpenACC test_gang_static_addition "
        do i = 1, n
            b(i) = i
        end do
        ...
        if(openacc_version >= 201306) then
            ...
            print *,"OpenACC test_gang_static_addition Completed"
        end if
