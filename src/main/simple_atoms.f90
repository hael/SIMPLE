...
public :: atoms, get_Z_and_radius_from_name
private
...
contains
    ...
    subroutine get_Z_and_radius_from_name(name, Z, r)
      ...
      element = trim(adjustl(uppercase_name))
      select case(element)
      ! organic
      case('H')
          Z = 1 ; r = 0.31
      ...
      case('CM')
          Z = 96; r = 1.69
      case default
        THROW_HARD('Unknown atom name! get_Z_and_radius_from_name')
      end select
    end subroutine get_Z_and_radius_from_name
    ...
    subroutine Z_and_radius_from_name( self, name, Z, r, el )
        ...
        call get_Z_and_radius_from_name(name,Z,r)
        uppercase_name = upperCase(name)
