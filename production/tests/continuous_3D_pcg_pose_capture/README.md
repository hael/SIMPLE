...
bash production/tests/continuous_3D_pcg_pose_capture/run_oracle_pose_capture.sh \
...
bash production/tests/continuous_3D_pcg_pose_capture/reanalyze_oracle_pose_capture.sh \
