...
contains
    ...
    subroutine new_abinitio2D( prgtab ) 
        ...
        call abinitio2D%add_input(UI_SRCH, 'refine', 'multi', 'Refinement mode', 'Refinement mode(snhc_smpl|snhc_ptree|single_ptree|prob){snhc_smpl}',&
        &'(snhc_smpl|snhc_ptree|single_ptree|prob){snhc_smpl}', .false., 'snhc_smpl', gui_submenu="search")
