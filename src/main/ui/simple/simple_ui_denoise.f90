...
contains
    ...
    subroutine new_ppca_denoise_classes( prgtab )
        ...
        call ppca_denoise_classes%add_input(UI_FILT, 'pca_mode', 'multi', 'PCA methods: PPCA, mixture PPCA, PPCA plus residual kPCA, standard SVD PCA or kernel PCA', 'PCA methods', '(ppca|mppca|ppca_kpca_resid|pca_svd|kpca){ppca}', .false., 'ppca')
