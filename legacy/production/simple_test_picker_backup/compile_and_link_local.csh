FLNAME=/Users/hael/src/fortran/simple_wfrederic/Simple_Restruct.projet/production/simple_tests/simple_test_picker/simple_test_picker
...
OPTION="-fimplicit-none -fall-intrinsics -ffree-form -cpp -fpic -fno-second-underscore -O3 -DMACOSX -fopenmp      "
...
$GFORTRAN $OPTION $LDFLAGS -I $OBJDIR -I $MODDIR -o $FLNAME \
                                              ...
                                              $OBJDIR/simple_denspeak_cluster.o \
