...
our$SIMPLE_PATH="/fbs/emsoftware2/LINUX/simple2";
...
our$CC_COMPILER = "gcc";
our$GCC_COMPILER = "g++";
our$MPI_F_COMPILER = "/usr/lib64/openmpi/mpif90";
our$FCOMPILER = "gfortran";
our$MPI_DIR="/usr";
our$MPI_DIR_INCLUDE="/usr/include/openmpi-x86_64";
#our$MPI_DIR="";
#our$MPI_DIR_INCLUDE="";
...
#for [MacOSX]
#our$OPT_DEV_TOOLS_NVIDIA = "'/Developer/GPU Computing'";
...
#for [MacOSX]
#our$OPENCL_SHARE_LIB = "shared/lib/darwin";
#The fftw lib default: /usr/lib/x86_64-linux-gnu
#for [linux]
our$FFTW_LIB="/fbs/emsoftware2/LINUX/simple2/fftw/lib";
#for [MacOSX]
#$FFTW_LIB="/usr/local/lib";
#for cluster need extra path after 
# > module load fftw/3.3.4-gcc ;
our$FFTW_INC="/fbs/emsoftware2/LINUX/simple2/fftw/include/"; #[Massive]
