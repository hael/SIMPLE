...
\noindent{}\textbf{Step 2:} Unzip the SIMPLE 2.5 tarball in this directory (assuming you have downloaded the tarball in the \texttt{<downloads>} directory)
...
This will install SIMPLE in the 'build' directory. If you wish to provide an alternative installation directory, substitute step 4 with
...
\noindent{}For instance, on MacOS Macports users may use: \texttt{FC=/opt/local FFTW\_DIR=/opt/local}; Fink users: \texttt{FC=/sw/ FFTW\_DIR=/sw/}.
