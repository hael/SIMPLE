...
contains
    ...
    subroutine new_ppca_denoise( prgtab )
        ...
        ! <empty>
        ! filter controls
        call ppca_denoise%add_input(UI_FILT, 'neigs', 'num', 'Number of eigencomponents (0 => auto for Nyström kPCA; try 50, 100)', 'Number of eigencomponents (0 => auto for Nyström kPCA; try 50, 100)', '# eigenvecs', .true., 100.0)
        ...
        call ppca_denoise%add_input(UI_FILT, 'kpca_nystrom_local_nbrs', 'num', 'Nyström local support neighbors (0 => landmarks only; try 16, 32)', 'Nyström local support neighbors (0 => landmarks only; try 16, 32)', '# local nbrs', .false., 32.0)
        ! mask controls
        ! <empty>
        ! computer controls
    ...
    subroutine new_ppca_denoise_classes( prgtab )
        ...
        ! <empty>
        ! filter controls
        call ppca_denoise_classes%add_input(UI_FILT, 'neigs', 'num', '# eigenvecs (0 => auto for Nyström kPCA; try 50, 100)', '# eigenvecs (0 => auto for Nyström kPCA; try 50, 100)', '# eigenvecs', .false., 0.0)
        ...
        call ppca_denoise_classes%add_input(UI_FILT, 'kpca_nystrom_local_nbrs', 'num', 'Nyström local support neighbors (0 => landmarks only; try 16, 32)', 'Nyström local support neighbors (0 => landmarks only; try 16, 32)', '# local nbrs', .false., 32.0)
        ! mask controls
        ! <empty>
        ! computer controls
