...
subroutine set_ui_params
    ...
    call quality_model%set_param(  'quality_model',   'multi',  'Class-average quality model', &
                                   'Built-in quality model preset(chunk_default_v2|pool_default_v1){chunk_default_v2}', &
                                   'Class-average quality model preset(chunk_default_v2|pool_default_v1){chunk_default_v2}', &
