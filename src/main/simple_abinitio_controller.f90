...
integer, parameter :: PROB_REFINE_STAGE          = 3     ! prob refinement       stages 3-4
integer, parameter :: PROB_NEIGH_REFINE_STAGE    = 5     ! prob_neigh refinement stages 5-8
integer, parameter :: STOCH_SAMPL_STAGE          = PROB_NEIGH_REFINE_STAGE     ! we switch from greedy to stochastic balanced class sampling
integer, parameter :: LPAUTO_STAGE               = PROB_NEIGH_REFINE_STAGE + 1 ! we switch on automatic low-pass limit estimation after one prob stage
integer, parameter :: NSPACE_SUB                 = 126
