...
contains
    ...
    subroutine cluster2D_exec( params, build, cline, which_iter, converged )
        ...
        l_prob_align_mode = trim(refine_flag) == 'prob'
        ...
        do ibatch=1,nbatches
            ...
            do iptcl_batch = 1,batchsz                     ! particle batch index
                ...
                if( l_prob_align_mode ) strategy2Dspec%eulprob_obj_part2D => eulprob_obj_part
        ...
        if( l_prob_align_mode ) call eulprob_obj_part%kill
