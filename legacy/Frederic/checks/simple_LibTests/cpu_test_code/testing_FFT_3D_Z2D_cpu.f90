! ============================================================================
! Name        : testing_FFT_3D_Z2D_cpu.f90
...
! ============================================================================
!
program testing_fft_3D_Z2D_cpu
...
!  call t_fft_cpu%new_fft_3D_DZ_cpu(nx,ny,nz)
  ...
  fhpq = 0.0d0
  call t_fft_cpu%gather_fft_3D_Z2D_cpu(nx,ny,nz,fuvw,fhpq)

  write(*,*)" !! Caution f(u,v,w)(Z) has been modified !! "

  fuvw_cpu = 0.0d0
  call t_fft_cpu%gather_fft_3D_D2Z_cpu(nx,ny,nz,fhpq,fuvw_cpu)
...
end program testing_fft_3D_Z2D_cpu
