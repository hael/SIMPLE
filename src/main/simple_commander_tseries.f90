...
contains
    ...
    subroutine exec_autorefine3D_nano_eo( self, cline )
        ...
        if( allocated(cavgs_stk) ) deallocate(cavgs_stk)
        ! final cleanup
        call del_file('spherical_mask.mrc')
        ! end gracefully
    ...
    contains
        ...
        subroutine clean
            ...
            call del_file(PER_ATOM_RMSDS_BIN)
            call del_file(PER_ATOM_RMSDS_TXT)
        ...
        subroutine copy_files( dir, i )
            ...
            call simple_copy_file(PER_ATOM_RMSDS_BIN, trim(dir)//trim(fbody_rmsds)   //'_iter'//int2str_pad(i,3)//'.bin')
            call simple_copy_file(PER_ATOM_RMSDS_TXT, trim(dir)//trim(fbody_rmsds)   //'_iter'//int2str_pad(i,3)//'.txt')
