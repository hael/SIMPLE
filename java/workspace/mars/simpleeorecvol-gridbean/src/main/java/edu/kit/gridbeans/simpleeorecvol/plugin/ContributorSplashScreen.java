...
public class ContributorSplashScreen extends JDialog {
	...
	setTitle("Contributors to the GridBean (java) "+VersionEoRecVol.getVersionEoRecVolGridBean());
	setModal(true);
	...
	String msg =
	    ...
	    "<br>" +
	    "The current GridBean (version :"+VersionEoRecVol.getVersionEoRecVolGridBean()+") is for Pre-processing Cryo-EM images using the SIMPLE library (version: "+VersionEoRecVol.getVersionEoRecVol()+").</p>"
