...
real, parameter :: OVERLAP_2D_FRAC     = 0.95   ! this limit is for when fractional update is on
...
real, parameter :: ANGTHRES_MI_PROJ_DEFAULT = 2.75 ! default euldist in degrees for when a projection direction recieves an overlap (mi_proj) of 1 
...
real, parameter :: FRACSRCHSPACE_FRAC  = 95.0  ! this limit is for when fractional update is on
