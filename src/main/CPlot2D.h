...
class aclass1
{
 ...
 public:
  aclass1()
    {
      std::cout << "aclass1 constructor\n";
      m_str1 = "this is default string";
    }
  ~aclass1()
    {
      std::cout << "aclass1 destructor\n";
    }
  ...
  {
    std::cout << "m_str = " << m_str1 << std::endl;
  }
};
...
class aclass2
{
 ...
 public:
  aclass2()
    {
      std::cout << "aclass2 constructor\n";
      m_i = 100;
    }
  ~aclass2()
    {
      std::cout << "aclass2 destructor\n";
    }
  void set_i(int i)
  {
    m_i = i;
  }
  void print_this(const aclass1& ac1)
  {
    std::cout << "m_i=" << m_i << " ... ";
    ac1.print_string();
  }
