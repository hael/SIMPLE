...
contains
    ...
    subroutine init_cmd_dict
        ...
        call chdict%push('draw_color',    'color of the cross that identify the picked particle {white|black}')
        ...
        call chdict%push('max_rad',       'particle longest  dim (in pixels)')
        call chdict%push('min_rad',       'particle shortest dim (in pixels)')
