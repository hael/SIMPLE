module cartesian_fourier_kb_test
use cartesian_fourier_kb_gather_test, only: run_packed_gather_derivative
use cartesian_fourier_test_helpers, only: assert_true
...
subroutine run_kb_derivative()
    ...
    write(*,'(a)') 'CARTESIAN_FOURIER_KB_DERIVATIVE: PASS'
...
end module cartesian_fourier_kb_test
