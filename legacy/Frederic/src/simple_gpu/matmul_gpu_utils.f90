...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! SOURCE
  subroutine get_SMatmul_gpu(transa,transb,m,n,k, &
                             alpha,               &
                             A,lda,               &
                             B,ldb,               &
                             beta,                &
    ...
    !function calls
    integer :: smatmul_tgpu

#if defined (CUDA)
    rc= smatmul_tgpu(transa,transb,m,n,k,&
                     alpha,              &
                     A,lda,              &
                     B,ldb,              &
                     beta,               &
                     prod_gpu,ldc)
#else
    call get_matmul_gpu_utils_warning()
    rc = RC_FAIL
    stop
#endif
    
    return
  end subroutine get_SMatmul_gpu
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! DESCRIPTION
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! SOURCE
  subroutine get_DMatmul_gpu(transa,transb,m,n,k, &
                             alpha,               &
                             A,lda,               &
                             B,ldb,               &
                             beta,                &
    ...
    integer :: rc = RC_SUCCESS
    !function calls
    integer :: dmatmul_tgpu

#if defined (CUDA)
    rc= dmatmul_tgpu(transa,transb,m,n,k,&
                     alpha,              &
                     A,lda,              &
                     B,ldb,              &
                     beta,               &
    ...
    return
  end subroutine get_DMatmul_gpu
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! DESCRIPTION
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! SOURCE
  subroutine get_CMatmul_gpu(transa,transb,m,n,k, &
                             alpha,               &
                             A,lda,               &
                             B,ldb,               &
                             beta,                &
    ...
    integer :: rc = RC_SUCCESS
    !function calls
    integer :: cmatmul_tgpu

#if defined (CUDA)
    rc= cmatmul_tgpu(transa,transb,m,n,k,&
                     alpha,              &
                     A,lda,              &
                     B,ldb,              &
                     beta,               &
    ...
    return
  end subroutine get_CMatmul_gpu
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! DESCRIPTION
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! SOURCE
  subroutine get_ZMatmul_gpu(transa,transb,m,n,k, &
                             alpha,               &
                             A,lda,               &
                             B,ldb,               &
                             beta,                &
    ...
    integer :: rc = RC_SUCCESS
    !function calls
    integer :: zmatmul_tgpu

#if defined (CUDA)
    rc= zmatmul_tgpu(transa,transb,m,n,k,&
                     alpha,              &
                     A,lda,              &
                     B,ldb,              &
                     beta,               &
    ...
    return
  end subroutine get_ZMatmul_gpu
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! DESCRIPTION
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! SOURCE
  subroutine get_matmul_gpu_utils_warning()
    implicit none
     write(*,*)"**************************WARNING******************************"
     ...
     stop
    return
  end subroutine get_matmul_gpu_utils_warning

end module matmul_gpu_utils
