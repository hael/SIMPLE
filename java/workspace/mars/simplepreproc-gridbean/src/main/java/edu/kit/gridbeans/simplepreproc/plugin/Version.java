...
public class Version {
	...
	/**
	 * version for the Simple GridBean
	 * @return v1.0:String
	 */
	public static String getVersionSimpleGridBean() {
		return "v1.0";
	}
	/**
	 * version for the Simple application
	 * @return November 12th 2015 - version 1.0:String
	 */
