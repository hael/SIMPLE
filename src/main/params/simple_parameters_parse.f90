...
contains
    ...
    module subroutine bind_input_carg(self, reg)
        ...
        call reg%add_char('ctf_correct_mode', self%ctf_correct_mode)
        ...
        call reg%add_char('pcg_solvent_check', self%pcg_solvent_check)
        ...
        call reg%add_char('preimage_auto', self%preimage_auto)
        call reg%add_char('rec_states', self%rec_states)
        call reg%add_char('nufilt', self%nufilt)
        ...
        call reg%add_char('memreport', self%memreport)
        call reg%add_char('mic_old_root', self%mic_old_root)
        ...
        call reg%add_char('nu_envmsk', self%nu_envmsk)
        call reg%add_char('nu_msk_rel', self%nu_msk_rel)
        call reg%add_char('objfun_den', self%objfun_den)
        call reg%add_char('regpass', self%regpass)
        ...
        call reg%add_char('pose_policy', self%pose_policy)
        ...
        call reg%add_char('quality_context', self%quality_context)
        ...
        call reg%add_char('column_sampling', self%column_sampling)
        ...
        call reg%add_char('vol_old_root', self%vol_old_root)
    ...
    module subroutine bind_input_files(self, reg)
        ...
        call reg%add_file('pcg_mskfile', self%pcg_mskfile,'M','S')
        ...
        call reg%add_file('infile', self%infile,'T','B')
        call reg%add_file('infile2', self%infile2,'T')
        call reg%add_file('pindfile', self%pindfile,'T')
        ...
        call reg%add_file('projfile_den', self%projfile_den,'O')
        call reg%add_file('projfile_orig', self%projfile_orig,'O')
        call reg%add_file('projfile_raw', self%projfile_raw,'O')
    ...
    module subroutine bind_input_dirs(self, reg)
        ...
        call reg%add_dir('cavg_new_root', self%cavg_new_root)
        ...
        call reg%add_dir('mic_new_root', self%mic_new_root)
        call reg%add_dir('new_root', self%new_root)
        call reg%add_dir('ptcl_new_root', self%ptcl_new_root)
        call reg%add_dir('star_datadir', self%star_datadir)
        call reg%add_dir('vol_new_root', self%vol_new_root)
    ...
    module subroutine bind_input_iarg(self, reg)
        ...
        call reg%add_int('box_rec',  self%box_rec)
        call reg%add_int('box_extract', self%box_extract)
        call reg%add_int('box_coarse', self%box_coarse)
        call reg%add_int('box_fine', self%box_fine)
        ...
        call reg%add_int('maxits_ml',  self%maxits_ml)
        ...
        call reg%add_int('memreport_interval', self%memreport_interval)
        call reg%add_int('minits', self%minits)
        call reg%add_int('nboxes_max', self%nboxes_max)
        call reg%add_int('nchunks', self%nchunks)
        call reg%add_int('nchunks_in_parallel', self%nchunks_in_parallel)
        ...
        call reg%add_int('niter', self%niter)
        ...
        call reg%add_int('n_probe_iters', self%n_probe_iters)
        ...
        call reg%add_int('pcafit', self%pcafit)
        call reg%add_int('nfits', self%nfits)
    ...
    module subroutine bind_input_rarg(self, reg)
        ...
        call reg%add_real('bandwidth_tune', self%bandwidth_tune)
        ...
        call reg%add_real('wiener_const', self%wiener_const)
        ...
        call reg%add_real('dm_alpha', self%dm_alpha)
        ...
        call reg%add_real('lpstop_coarse', self%lpstop_coarse)
        call reg%add_real('lpstop_fine', self%lpstop_fine)
        ...
        call reg%add_real('nu_msk_beta', self%nu_msk_beta)
        call reg%add_real('nu_msk_dens', self%nu_msk_dens)
        call reg%add_real('nu_msk_sig', self%nu_msk_sig)
        call reg%add_real('objfun_den_w', self%objfun_den_w)
        call reg%add_real('osmpd', self%osmpd)
        call reg%add_real('overlap', self%overlap)
        call reg%add_real('phranlp', self%phranlp)
        call reg%add_real('phshift_max', self%phshift_max)
        call reg%add_real('phshift_min', self%phshift_min)
        ...
        call reg%add_real('regpass_fsc', self%regpass_fsc)
        call reg%add_real('res_target', self%res_target)
        call reg%add_real('res_threshold', self%res_threshold)
        call reg%add_real('rtol', self%rtol)
        call reg%add_real('pcg_solvent_lambda', self%pcg_solvent_lambda)
