...
\begin{Verbatim}[commandchars=+\[\]]
    ...
    The +textbf[quick brown fox] jumped over $ the lazy dog.
    The +textit[quick brown fox] jumped over the lazy dog.
\end{Verbatim}
...
\label{cleanup2D}
\prgname{cleanup2D} is a distributed workflow implementing a reference-free 2D alignment/clustering algorithm, executed by simple\_distr\_exec
\begin{Verbatim}[commandchars=+\[\],fontsize=\small]
+underline[USAGE]
