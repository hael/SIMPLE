module continuous_3D_pcg_refinement_forward_path_test
use continuous_3D_pcg_refinement_fixed_reference_test, only: measure_exact_pose_fit
...
subroutine run_forward_path_diagnostic()
    ...
    type(pcg_fourier_workspace) :: raw_truth_workspace
...
end module continuous_3D_pcg_refinement_forward_path_test
