module pose_cont_refinement_operator_contract_support
...
subroutine evaluate_contract_model(reference,orientations,observed,nprobes,model_kind,apply_taper,metrics)
    ...
    call workspace%new_prepared_test(model_volume)
...
end module pose_cont_refinement_operator_contract_support
