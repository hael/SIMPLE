...
! This is a cross-configuration regression, not a pose-capture claim: it requires
! finite exact/nonstationary states and safe monotone LM transactions.
...
!! The Cartesian product covers box, morphology, rotation axis, shift sign, CTF,
!! variance profile, and Fourier range. The final row count proves full coverage.
                        ...
                        do ctf_mode = 1, N_CTF_MODES
                            ...
                            do variance_profile = 1, N_VARIANCE_PROFILES
                                ...
                                do range_index = 1, N_FOURIER_RANGES
                                    ...
                                    ! Exact pose must reproduce the prepared observation before LM starts.
                                    ...
                                    ! Two LM iterations probe finite, bounded, monotone transaction behavior.
