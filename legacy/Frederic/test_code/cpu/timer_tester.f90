...
! Description : tests the functionality of the timing routine in C and using
!             : the timing module (use physsym_timing) for a 
!             : matrix multiplication of SU(3) random nxm mxn dense matrix.
! ============================================================================
program timer_tester
  ...
  call su3randomlinks_mul_timing_cpu(elps_tm,t1s,t2s)
