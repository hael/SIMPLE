...
public class ParameterPanel extends GridBeanPanel {
	...
	private void linkComponents() throws DataSetException {
		linkTextField(SimpleStackopsGridBean.TITLE, tfdTitle);
		setValueTranslator(SimpleStackopsGridBean.TITLE, new StringValueTranslator());
		setValueValidator(SimpleStackopsGridBean.TITLE, new NonEmptyStringValidator());
