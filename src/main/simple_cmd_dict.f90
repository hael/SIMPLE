...
contains
    ...
    subroutine init_cmd_dict
        ...
        call chdict%push('automatic',     'automatic threshold selection (yes|no)')
        ...
        call chdict%push('detector',      'edge detector algorithm (sobel|canny)')
        ...
        call chdict%push('startype',      'specifying startype for STAR formated projects for import'//&
            '(m[icrographs]|ctf[estimation]|c[avg|lass2d]|p[tcls|articles])')
        ...
        call chdict%push('infile',        'file with inputs(.txt|.simple)')
        ...
        call chdict%push('masscen',       'center to center of gravity(yes|no){no}')
        ...
        call chdict%push('pgrp_start',    'initial point-group symmetry(cn|dn|t|o|i)')
