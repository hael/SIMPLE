! Test-only fixtures discovered through the existing PCG-suite filename glob.
module continuous_3D_pcg_reconstruction_test_helpers
...
end module continuous_3D_pcg_reconstruction_test_helpers
