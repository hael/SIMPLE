module pose_cont_refinement_rotation_test
...
subroutine run_rotation_gradient()
    ...
    call workspace%new_prepared_test(phantom)
    ...
    write(*,'(a,3(es14.6,1x))') 'POSE_CONT_REFINEMENT_ROTATION Jv fixed-cell errors: ', jvp_errors
    write(*,'(a,3(es14.6,1x))') 'POSE_CONT_REFINEMENT_ROTATION pose-gradient errors: ', objective_errors
    write(*,'(a,3(es14.6,1x))') 'POSE_CONT_REFINEMENT_ROTATION weighted-gradient errors: ', weighted_errors
    write(*,'(a,5(es14.6,1x))') 'POSE_CONT_REFINEMENT_ROTATION column-Jv errors: ',column_jvp_errors
    write(*,'(a,5(es14.6,1x))') 'POSE_CONT_REFINEMENT_ROTATION probe column-Jv errors: ', &
        &probe_column_jvp_errors
    write(*,'(a,5(es14.6,1x))') 'POSE_CONT_REFINEMENT_ROTATION component-gradient errors: ', &
        &component_grad_errors
    write(*,'(a,5(es14.6,1x))') 'POSE_CONT_REFINEMENT_ROTATION probe component-gradient errors: ', &
        &probe_component_grad_errors
    write(*,'(a,5(es14.6,1x))') 'POSE_CONT_REFINEMENT_ROTATION weighted column-Jv errors: ', &
        &weighted_column_jvp_errors
    write(*,'(a,5(es14.6,1x))') 'POSE_CONT_REFINEMENT_ROTATION weighted component-gradient errors: ', &
        &weighted_component_grad_errors
    write(*,'(a,3(es14.6,1x),2(i0,1x))') 'POSE_CONT_REFINEMENT_ROTATION update/orthogonal/determinant/fixed/switch: ', &
        &update_error,orthogonality_error,determinant_error,fixed_cell_count,measured_switches
    write(*,'(a,2(es14.6,1x))') 'POSE_CONT_REFINEMENT_ROTATION input orthogonal/determinant errors: ', &
        &input_orthogonality_error,input_determinant_error
    write(*,'(a)') 'POSE_CONT_REFINEMENT_ROTATION_GRADIENT: PASS'
...
end module pose_cont_refinement_rotation_test
