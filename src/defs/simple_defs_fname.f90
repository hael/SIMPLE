...
character(len=*), parameter :: NUFILT_SUFFIX                 = '_nu_filt'
character(len=*), parameter :: NULOCRES_SUFFIX               = '_nu_locres'
character(len=*), parameter :: NUEVIDENCE_SUFFIX             = '_nu_evidence'
character(len=*), parameter :: NUSHARP_SUFFIX                = '_nu_sharp'
character(len=*), parameter :: PPROC_NU_SUFFIX                = '_pproc_nu'
character(len=*), parameter :: NUENVMSK_SUFFIX               = '_nu_envmask'
...
character(len=*), parameter :: MOVTHUMB_FBODY                = 'movthumb'
! AUTOMASK2D
...
character(len=*), parameter :: PCG_SOLVENT_WEIGHT_FBODY      = 'pcg_solvent_weight_state' !< per-half w(r) of the PCG solvent prior (inspection only)
...
character(len=*), parameter :: SRCHSPACE_MAP_FNAME           = 'srchspace_map.bin'
! character constants
