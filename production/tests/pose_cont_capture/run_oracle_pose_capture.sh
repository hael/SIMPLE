...
Usage:
  run_oracle_pose_capture.sh [--output-parent "$HOME/Projects"] \
    [--executable simple_test_pose_cont_refinement]

Run the isolated Cartesian pose-capture sweep. The script stores the raw
...
cp "$SOURCE_ROOT/production/tests/simple_pose_cont_refinement_pose_capture_test.f90" \
    "$RESULT_ROOT/input/"
cp "$SOURCE_ROOT/production/tests/simple_pose_cont_refinement_pose_mechanism_test.f90" \
    "$RESULT_ROOT/input/"
cp "$SOURCE_ROOT/production/tests/simple_test_pose_cont_refinement.f90" \
    "$RESULT_ROOT/input/"
...
production/tests/simple_pose_cont_refinement_pose_capture_test.f90
production/tests/simple_pose_cont_refinement_pose_mechanism_test.f90
production/tests/simple_test_pose_cont_refinement.f90
