...
public class SimpleEoRecVolCalculation extends ApplicationWrapper 
{

  private static Logger log = Logger.getLogger(SimpleEoRecVolCalculation.class.getName());
  ...
  /** Constructor */
  public SimpleEoRecVolCalculation(String[] args) 
  {
  ...
  protected void execute() throws Throwable 
  {
    ...
    invokesimpleEoRecVol();
  }

  private void invokesimpleEoRecVol() throws IOException 
  {
    ...
    log.info("Execute simpleEoRecVol: " + run_application);
