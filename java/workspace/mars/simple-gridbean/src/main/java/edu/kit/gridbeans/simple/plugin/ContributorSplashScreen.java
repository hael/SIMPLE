...
public class ContributorSplashScreen extends JDialog {
	...
	setTitle("Contributors to the GridBean (java) "+Version.getVersionSimpleGridBean());
	setModal(true);
	...
	String msg =
	    ...
	    "<br>" +
	    "The current GridBean (version :"+Version.getVersionSimpleGridBean()+") is for processing Cryo-EM images using the SIMPLE library (version: "+Version.getVersionSimple()+").</p>"
