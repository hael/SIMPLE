! ============================================================================
! Name        : testing_fft_3D_C2C_cpu.f90
...
! ============================================================================
!
program testing_fft_3D_C2C_cpu
...
!  call t_fft_cpu%new_fft_3D_CC_cpu(nx,ny,nz)
  ...
  fhpq = 0.0
  call t_fft_cpu%gather_fft_3D_C2C_cpu(nx,ny,nz,fuvw,fhpq,FFTW_FORWARD)

  fuvw_cpu = 0.0
  call t_fft_cpu%gather_fft_3D_C2C_cpu(nx,ny,nz,fhpq,fuvw_cpu,FFTW_BACKWARD)
...
end program testing_fft_3D_C2C_cpu
