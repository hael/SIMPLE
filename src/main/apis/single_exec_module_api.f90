...
commander_crys_score, commander_tseries_atoms_rmsd, commander_tseries_core_atoms_analysis, commander_detect_atoms
...
commander_trajectory_make_projavgs, commander_trajectory_core_finder
