!@descr: GUI metadata for the stream pool-2D stage — particle counts, initial reference selection, and user-input flag
!==============================================================================
...
!     set()                      — assign particle counts and stage field
...
contains
  ...
  ! count changes.
  subroutine set( self, stage, iteration, particles_imported, particles_accepted, particles_rejected )
  ...
  function get( self, stage, iteration, particles_imported, particles_accepted, particles_rejected, last_import_time, user_input ) result( l_assigned )
