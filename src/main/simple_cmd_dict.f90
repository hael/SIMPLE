...
contains
    subroutine init_cmd_dict
        ...
        call chdict%push('dfclose',       'close to focus defocus limit for setting state flag(in microns){1}')
        call chdict%push('dffar',         'far from focus defocus limit for setting state flag(in microns){4}')
