...
usage:
  scripts/test_review_dossier.py [--timing build_test_runs/<label>/results.tsv ...]
                                 ...
                                 [--record doc/refactoring_notes/completed/test_review_record.md]
...
def inventory(tests, pairs, out, record):
    ...
    L = ['# Test inventory', '',
         ...
         'Generated from the sources and the closed record of the test review,',
         '`doc/refactoring_notes/completed/test_review_record.md`: the verdict and note columns and the',
         'retired-tests table come from there (section 9 of the archived plan,',
         '`doc/refactoring_notes/completed/uniform_test_environment_refactoring.md`). Do not edit this file.', '',
