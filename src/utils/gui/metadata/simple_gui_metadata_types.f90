...
enum, bind(c)
  ...
  enumerator :: GUI_METADATA_STREAM_REFERENCE_PICKING_CLS2D_TYPE      ! 28
  ! particle sieving stage
  enumerator :: GUI_METADATA_STREAM_PARTICLE_SIEVING_TYPE           ! 29
  enumerator :: GUI_METADATA_STREAM_PARTICLE_SIEVING_CLS2D_TYPE     ! 30
  enumerator :: GUI_METADATA_STREAM_PARTICLE_SIEVING_CLS2D_REF_TYPE ! 31
  ! pool 2D stage
  enumerator :: GUI_METADATA_STREAM_POOL2D_TYPE               ! 32
  enumerator :: GUI_METADATA_STREAM_POOL2D_CLS2D_TYPE         ! 33
  enumerator :: GUI_METADATA_STREAM_POOL2D_SNAPSHOT_TYPE      ! 34
  enumerator :: GUI_METADATA_STREAM_POOL2D_SNAPSHOT_CLS2D_TYPE ! 35
  ! multistate abinitio3D stage
  enumerator :: GUI_METADATA_STREAM_ABINITIO3D_MULTISTATE_TYPE        ! 36
  enumerator :: GUI_METADATA_STREAM_ABINITIO3D_MULTISTATE_REPROJ_TYPE ! 37
end enum
