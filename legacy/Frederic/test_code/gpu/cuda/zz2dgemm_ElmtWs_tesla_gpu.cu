...
extern "C" void
zz2dgemm_ElmtWs_tesla_gpu_( char TRANSA, char TRANSB,
			    int m, int n, int k,
			    double alpha, 
			    ...
			    double *C, int ldc)
{
  ...
  if(TRANSA=='N') {
	  ...
	  /*====================================================================
	    ===================C = alpha * A * B + beta * C ====================
	    ==================================================================*/
	  rc = zz2dgemm_kernel_N_N(dC,A,B, m, n, k,lda, ldb, ldc, alpha, beta);
	} 
      else 
	{
	  if(lda < m ) {rc = -1; return ;}
	  ...
	  /*====================================================================
	    ...
	    ==================================================================*/
	  rc = zz2dgemm_kernel_N_T(dC,A,B, m, n, k,lda, ldb, ldc, alpha, beta);
	}
    } 
  else
    {
	...
	/*======================================================================
	  ...
	  ====================================================================*/
	rc = zz2dgemm_kernel_T_N(dC,A,B, m, n, k,lda, ldb, ldc, alpha, beta);
      }
      else
	{
	  if(lda < k) {rc = -1; return ;}
	  ...
	  /*====================================================================
	    ...
	    ==================================================================*/
	  rc = zz2dgemm_kernel_T_T(dC,A,B, m, n, k,lda, ldb, ldc, alpha, beta);
	}
    }
