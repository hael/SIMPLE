...
contains
    ...
    subroutine init_cmd_dict
        ...
        call chdict%push('oritab',        'table of orientations(*.asc/*.bin/*.txt)')
        call chdict%push('oritab2',       '2nd table of orientations(*.asc/*.bin/*.txt)')
        call chdict%push('oritab3D',      'table of 3D orientations(*.asc/*.bin/*.txt)')
