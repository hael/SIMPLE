...
contains
    ...
    subroutine init_cmd_dict
        ...
        call chdict%push('imgfilt2D',     'whether to filter the particle image for 2D')
        call chdict%push('imgfilt3D',     'whether to filter the particle image for 3D')
        ...
        call chdict%push('objfun',        'objective function(cc|ccres|ccreg){cc}')
