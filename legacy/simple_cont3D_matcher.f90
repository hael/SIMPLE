...
contains
    ...
    subroutine cont3D_exec( b, p, cline, which_iter, converged )
        ...
        if(alloc_stat.ne.0)call allocchk("simple_cont3D_matcher::cont3D_exec  ",alloc_stat)
        ...
        do batch = 1, nbatches
            ...
            if(alloc_stat.ne.0)call allocchk('In pcont3D_matcher::pcont3D_exec',alloc_stat)
            do iptcl = fromp, top
    ...
    subroutine prep_eopairs(b, p, eopart)
        ...
        if(alloc_stat.ne.0)call allocchk("simple_cont3D_matcher::prep_eopairs ",alloc_stat)
