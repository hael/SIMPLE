...
contains
    ...
    module subroutine bind_input_carg(self, reg)
        ...
        call reg%add_char('chunk_mode', self%chunk_mode)
    ...
    module subroutine bind_input_iarg(self, reg)
        ...
        call reg%add_int('preimage_ndim', self%preimage_ndim)
        ...
        call reg%add_int('chunk_max_len', self%chunk_max_len)
        call reg%add_int('chunk_max_shift', self%chunk_max_shift)
        call reg%add_int('chunk_min_len', self%chunk_min_len)
    ...
    module subroutine bind_input_rarg(self, reg)
        ...
        call reg%add_real('chunk_count_penalty', self%chunk_count_penalty)
