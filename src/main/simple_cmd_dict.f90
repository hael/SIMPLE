...
contains
    ...
    subroutine init_cmd_dict
        ...
        call chdict%push('comlindoc',     'clustering_shc_nclsX.txt')
        ...
        call chdict%push('dopick',        'execute picking step (in preprocess){yes}')
        ...
        call chdict%push('hp_ctfestimate',    'high-pass limit 4 ctf_estimate(in A)')
        ...
        call chdict%push('refine',        'refinement mode(snhc|single|multi|greedy_single|greedy_multi|cluster|clustersym){no}')
