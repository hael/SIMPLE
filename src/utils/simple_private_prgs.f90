...
contains
    ...
    subroutine init_cmd_dict
        ...
        call cmd_dict%push('automsk',       'envelope masking(yes|tight|snr|no){no}')
        ...
        call cmd_dict%push('pca_mode',      'PCA/diffusion method(ppca|ppca_kpca_resid|pca_svd|kpca|diffusion_maps|steerable_diff_map){ppca}')
