...
if (debug) call test_exp4%write_int_dist( 'int_dist_before_high_filter.csv')
...
if (debug) call test_exp4%write_int_dist( 'int_dist_after_high_filter.csv')
call test_exp4%distance_filter(dist_thres)
if (debug) call test_exp4%write_corr_dist('corr_dist_after_dist_filter_high.csv')
if (debug) call test_exp4%write_int_dist( 'int_dist_after_dist_filter_high.csv')
